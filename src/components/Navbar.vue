<template>
    <div id="nav" class="bg-fixed w-screen space-x-4 text-center bg-black bg-opacity-90 text-2xl p-2 h-12">
        <p class="rounded bg-gray-600 text-white float-left w-28">luuk180</p>
